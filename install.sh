...
if [ -f "/etc/debian_version" ]; then
        ...
        echo "[i] We will now download OyShell..."
        sudo git clone https://github.com/Taguar258/OyShell.git > /dev/null 2>&1 || echo "[!] Could not download OyShell."
        cd OyShell > /dev/null 2>&1
        ...
        echo "[i] We will now install OyShell..."
        sudo bash ./install_to_bin.sh || echo "[!] Could not install OyShell."
        ...
        git clone https://github.com/Taguar258/OyShell.git > /dev/null 2>&1 || echo "[!] Please install git"
        cd OyShell
